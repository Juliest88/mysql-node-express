...
router.patch('/id/:id', auth, updateUserSchema, userController.updateUser); // localhost:3000/api/v1/usersid/1 , using patch for partial update
router.delete('/id/:id', auth, userController.deleteUser); // localhost:3000/api/v1/usersid/1
